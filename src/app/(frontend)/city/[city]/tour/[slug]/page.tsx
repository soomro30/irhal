...
export async function generateTourMetadata(
  ...
  const item = city ? getGuideItem(city, "tour", slug) : undefined;
  if (!city || !item) return {};
  ...
  return pageMetadata({
    ...
    path: `${locale === "ar" ? "/ar" : "/en"}/city/${city.slug}/tour/${item.slug}`,
  });
}

export async function generateMetadata(props: Props): Promise<Metadata> {
  return generateTourMetadata(props);
}
